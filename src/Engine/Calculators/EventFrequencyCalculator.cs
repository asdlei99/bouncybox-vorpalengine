...
{
    /// <summary>
    ///     Calculates how often certain events occur over the total elapsed time of a timer.
    /// </summary>
    public class EventFrequencyCalculator
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="EventFrequencyCalculator" /> type.
        /// </summary>
        ...
        /// <summary>
        ///     Resets the event count to zero and resets the timer.
        /// </summary>
        public void Reset()
        {
            _stopwatch.Reset();
        ...
        /// <summary>
        ///     Resets the event count to zero and restarts the timer.
        /// </summary>
        public void Restart()
        {
            _stopwatch.Restart();
