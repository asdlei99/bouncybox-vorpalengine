...
{
    /// <summary>A sine wave that uses a <see cref="Stopwatch" /> for x-axis values.</summary>
    public class StopwatchSineWave : SineWave
    {
        private readonly Stopwatch _stopwatch;

        /// <summary>Initializes a new instance of the <see cref="StopwatchSineWave" /> type.</summary>
        ...
        /// <param name="waveOffset">The x-axis offset.</param>
        /// <param name="timeSpanUnitDelegate">A delegate that determines what <see cref="TimeSpan" /> component to use for all calculations.</param>
        public StopwatchSineWave(float trough, float crest, TimeSpan wavelength, WaveOffset waveOffset, Func<TimeSpan, float>? timeSpanUnitDelegate = null)
