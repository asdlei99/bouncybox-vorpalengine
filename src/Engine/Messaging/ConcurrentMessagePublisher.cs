...
{
    /// <summary>
    ///     Proxies publishing messages to a concurrent message queue to allow for method chaining.
    /// </summary>
        ...
        where TMessageBase : IGlobalMessage
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ConcurrentMessagePublisher{TMessageBase}" /> type.
        /// </summary>
