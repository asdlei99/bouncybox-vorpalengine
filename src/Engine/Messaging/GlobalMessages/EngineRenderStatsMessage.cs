...
{
    /// <summary>
    ///     A global message that reports engine render statistics.
    /// </summary>
    public struct EngineRenderStatsMessage : IGlobalMessage
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="EngineRenderStatsMessage" /> type.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the mean frametime.
        /// </summary>
        public TimeSpan? MeanFrametime { get; }

        /// <summary>
        ///     Gets the minimum frametime.
        /// </summary>
        public TimeSpan? MinimumFrametime { get; }

        /// <summary>
        ///     Gets the maximum frametime.
        /// </summary>
