...
{
    /// <summary>
    ///     Proxies publishing messages to a message queue to allow for method chaining.
    /// </summary>
        ...
        where TMessageBase : IMessage
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="MessagePublisher{TMessageBase}" /> type.
        /// </summary>
