...
{
    /// <summary>
    ///     Represents an in-memory thread-safe message queue.
    /// </summary>
    public interface IConcurrentMessageQueue<TMessageBase>
        where TMessageBase : IGlobalMessage
    {
        /// <summary>
        ///     Queues a message for dispatch in a subsequent call to <see cref="DispatchQueued" />.
        /// </summary>
        ...
        /// <summary>
        ///     Subscribes to a message and provides a handler delegate that will process published messages of the specified type.
        /// </summary>
        ...
        /// <summary>
        ///     Dequeues all queued messages, dispatching each message to its associated concurrent message dispatch queue.
        /// </summary>
        void DispatchQueued();
    }
}