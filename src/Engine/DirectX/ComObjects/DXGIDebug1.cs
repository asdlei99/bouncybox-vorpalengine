...
{
    /// <summary>Proxies the <see cref="IDXGIDebug1" /> COM interface.</summary>
    // ReSharper disable once InconsistentNaming
    public unsafe class DXGIDebug1 : ComObject<IDXGIDebug1>
    {
        private ComPtr<IDXGIDebug1> _dxgiDebug1;

        /// <summary>Initializes a new instance of the <see cref="DXGIDebug1" /> type.</summary>
        ...
        /// <summary>Proxies <see cref="IDXGIDebug1.ReportLiveObjects" />.</summary>
