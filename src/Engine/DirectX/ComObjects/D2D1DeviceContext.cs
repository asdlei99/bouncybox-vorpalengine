...
namespace BouncyBox.VorpalEngine.Engine.DirectX.ComObjects
{
    ...
    public unsafe class D2D1DeviceContext : ComObject<ID2D1DeviceContext>
    {
        ...
        /// <summary>Proxies <see cref="ID2D1DeviceContext.BeginDraw" />.</summary>
        public void BeginDraw()
        {
            Pointer->BeginDraw();
        }

        /// <summary>Proxies <see cref="ID2D1DeviceContext.Clear" />.</summary>
        public void Clear(DXGI_RGBA* color = null)
        {
            Pointer->Clear(color);
        }

        /// <summary>Proxies <see cref="ID2D1DeviceContext.CreateBitmapFromDxgiSurface" />.</summary>
        ...
        /// <summary>Proxies <see cref="ID2D1DeviceContext.DrawText" />.</summary>
        ...
        /// <summary>Proxies <see cref="ID2D1DeviceContext.EndDraw" />.</summary>
        public int EndDraw()
        {
            return Pointer->EndDraw(null, null);
        }

        /// <summary>Proxies <see cref="ID2D1DeviceContext.SetTarget" />.</summary>
        public void SetTarget(D2D1Bitmap1? d2d1Bitmap1)
        {
            Pointer->SetTarget(d2d1Bitmap1 != null ? (ID2D1Image*)d2d1Bitmap1.Pointer : null);
        }

        /// <summary>Proxies <see cref="ID2D1DeviceContext.SetTextAntialiasMode" />.</summary>
