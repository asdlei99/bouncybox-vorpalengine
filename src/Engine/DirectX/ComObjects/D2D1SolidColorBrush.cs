...
namespace BouncyBox.VorpalEngine.Engine.DirectX.ComObjects
{
    ...
    public unsafe class D2D1SolidColorBrush : ComObject<ID2D1SolidColorBrush>
    {
        ...
        /// <summary>Proxies <see cref="ID2D1SolidColorBrush.GetColor" /> and <see cref="ID2D1SolidColorBrush.SetColor" />.</summary>
        ...
        /// <summary>Casts the object to <see cref="D2D1Brush" />.</summary>
