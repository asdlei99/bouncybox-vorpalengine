...
{
    /// <summary>
    ///     Proxies the <see cref="ID3D11Device" /> COM interface.
    /// </summary>
    public unsafe class D3D11Device : ComObject<ID3D11Device>
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="D3D11Device" /> type by proxying <see cref="D3D11.D3D11CreateDevice" />.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the actual feature level chosen by Direct3D.
        /// </summary>
        ...
        /// <summary>
        ///     Queries the <see cref="ID3D11Device" /> for <see cref="IDXGIDevice" />.
        /// </summary>
