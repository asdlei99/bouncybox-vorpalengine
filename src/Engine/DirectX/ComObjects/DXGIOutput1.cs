...
{
    /// <summary>
    ///     Proxies the <see cref="IDXGIOutput1" /> COM interface.
    /// </summary>
    ...
    public unsafe class DXGIOutput1 : ComObject<IDXGIOutput1>
    {
        ...
        /// <inheritdoc />
        /// <summary>
        ///     Initializes a new instance of the <see cref="DXGIOutput1" /> type.
        /// </summary>
        ...
        /// <summary>
        ///     Proxies <see cref="IDXGIOutput1.FindClosestMatchingMode1" />.
        /// </summary>
