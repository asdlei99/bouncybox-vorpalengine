...
{
    /// <summary>
    ///     Proxies the <see cref="ID2D1Factory" /> COM interface.
    /// </summary>
    public unsafe class D2D1Factory : ComObject<ID2D1Factory>
    {
        ...
        /// <inheritdoc />
        /// <summary>
        ///     Initializes a new instance of the <see cref="D2D1Factory" /> type.
        /// </summary>
        ...
        /// <summary>
        ///     Queries the <see cref="ID2D1Factory" /> for <see cref="ID2D1Multithread" />.
        /// </summary>
