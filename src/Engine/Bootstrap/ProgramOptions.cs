...
{
    /// <summary>Encapsulates common command line parameters.</summary>
    public class ProgramOptions
    {
        /// <summary>Gets or sets a value that indicates whether logging is enabled.</summary>
        [Option("loggingenabled", HelpText = "Determines whether logging is enabled.", Default = true)]
        public bool IsLoggingEnabled { get; set; }

        /// <summary>Gets or sets the destination for log output.</summary>
        ...
        /// <summary>Gets or sets a value that controls the minimum log level to output.</summary>
