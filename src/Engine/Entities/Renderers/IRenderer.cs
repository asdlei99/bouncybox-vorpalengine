...
{
    /// <summary>Represents a renderer's capability to use resources.</summary>
    public interface IRenderer : IEntity
    {
        ...
        /// <summary>Releases resources created by this renderer.</summary>
        void ReleaseResources();
    }

    /// <summary>Represents an entity that renders a render state.</summary>
