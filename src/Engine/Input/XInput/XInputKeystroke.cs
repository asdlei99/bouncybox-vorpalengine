...
namespace BouncyBox.VorpalEngine.Engine.Input.XInput
{
    ...
    {
        /// <summary>
        ///     Gets the XInput virtual key.
        /// </summary>
        public XInputVirtualKey VirtualKey { get; }

        /// <summary>
        ///     Gets the XInput keystroke flags.
        /// </summary>
        public XInputKeystrokeFlags Flags { get; }

        /// <summary>
        ///     Gets the UNICODE representation of the virtual key.
        /// </summary>
        public char Unicode { get; }

        /// <summary>
        ///     Initializes a new instance of the <see cref="XInputKeystroke" /> type.
        /// </summary>
